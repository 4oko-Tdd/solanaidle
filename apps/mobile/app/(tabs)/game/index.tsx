              ...
              <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 6 }}>
                {(
                  [
                    ...
                    { label: "Seed LB", color: "#4a7a9b", onPress: async () => { try { const r = await api<{ message: string }>("/dev/seed-leaderboard", { method: "POST" }); toast(r.message, "success"); } catch (e: any) { toast(e?.message ?? "Failed", "error"); } } },
